const i18n = {
    en: {
        appName: "XSnap",
        tagline: "Turn any Tweet/X link into a beautiful shareable image",
        placeholder: "Paste a Tweet / X link here...",
        generate: "Generate",
        bgStyle: "Background Style",
        cardStyle: "Card Style",
        layout: "Multi-image Layout",
        grid: "Grid",
        waterfall: "Waterfall",
        download: "Download Image",
        toastFetch: "Fetching tweet data...",
        toastSuccess: "Success!",
        toastFailure: "Failed to fetch: ",
    ...
    zh: {
        appName: "XSnap",
        tagline: "将任意 Tweet/X 链接，转化为精美的分享图",
        placeholder: "在这里粘贴 Tweet / X 的链接...",
        generate: "生成",
        bgStyle: "背景样式",
        cardStyle: "卡片样式",
        layout: "多图布局",
